...
namespace PipelinePattern
{
    ...
    public static class BitmapExtensions
    {
        ...
        public static Bitmap ConvertToBlackAndWhite(this Bitmap source, double amount)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Bitmap bitmap = null;
            ...
            try
            {
                ...
                tempBitmap = tempBitmap.Clone(new Rectangle(0, 0, tempBitmap.Width, tempBitmap.Height), PixelFormat.Format1bppIndexed);
                bitmap = tempBitmap;
                tempBitmap = null;
            }
            finally
